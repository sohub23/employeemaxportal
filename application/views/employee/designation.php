		...
		<section class="panel">
			...
			<?php echo form_open($this->uri->uri_string()); ?>
				...
				<?php endif; ?>
					...
					<div class="form-group mb-md">
						<label class="control-label"><?php echo translate('grades'); ?> </label>
						<input type="text" class="form-control" name="grade" value="<?php echo set_value('grade'); ?>" />
						<span class="error"><?php echo form_error('grade'); ?></span>
					</div>
				</div>
	...
	<section class="panel">
		...
		<?php echo form_open('employee/designation_edit', array('class' => 'frm-submit')); ?>
			<div class="panel-body">
				...
				<div class="form-group mb-md">
					<label class="control-label"><?php echo translate('grades'); ?></label>
					<input type="text" class="form-control" name="grade" id="egrade" value="" />
					<span class="error"></span>
				</div>
			</div>
